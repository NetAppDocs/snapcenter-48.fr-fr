...
** Données qui se trouvent sur les systèmes primaires et secondaires ONTAP FAS ou AFF et protégées sur le stockage d'objets StorageGRID local à l'aide de l'intégration de sauvegarde et de récupération NetApp
...
** Données qui se trouvent sur les systèmes primaires et secondaires ONTAP FAS ou AFF et protégées dans le stockage d'objets et d'archives dans le cloud à l'aide de l'intégration de sauvegarde et de récupération NetApp
