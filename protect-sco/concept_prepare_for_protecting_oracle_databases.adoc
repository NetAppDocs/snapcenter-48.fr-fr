...
* Si vous disposez de bases de données Oracle dans des environnements SAN, assurez-vous que l'environnement SAN est configuré conformément aux recommandations mentionnées dans le https://library.netapp.com/ecm/ecm_download_file/ECMP1119218["Paramètres d'hôte affectés par les utilitaires hôtes AIX"^] guide.
