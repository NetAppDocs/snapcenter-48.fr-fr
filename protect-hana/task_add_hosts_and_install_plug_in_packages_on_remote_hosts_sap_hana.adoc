...
* Pour que la réplication système SAP HANA détecte les ressources sur les systèmes principaux et secondaires, il est recommandé d'ajouter les systèmes principaux et secondaires à l'aide de l'utilisateur root ou sudo.
