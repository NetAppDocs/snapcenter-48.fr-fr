...
NOTE: Pour la réplication système SAP HANA, le total des copies Snapshot prises sera égal à la conservation définie pour le groupe de ressources.  La suppression de la copie Snapshot la plus ancienne est basée sur le nœud sur lequel se trouve la copie Snapshot la plus ancienne.
