...
Aucun travail ne doit être en cours d'exécution.
Vous pouvez supprimer un travail spécifique en fournissant un ID de travail ou en supprimant des travaux au cours d'une période donnée.
