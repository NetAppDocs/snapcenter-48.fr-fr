...
Une fois la maintenance de l'hôte terminée, vous pouvez mettre l'hôte hors mode maintenance en cliquant sur *Activer le programme*.
Vous pouvez activer la planification de plusieurs hôtes simultanément.
